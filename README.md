...
- ✅ **Semântica HTML** — Estrutura limpa e acessível
...
1. Clone o repositório:
   ...
   ```bash
   git clone https://github.com/cabral-bento/web_project_homeland.git
   ```
...
vendor/          → Fontes e estilos base
images/          → Imagens do projeto
pages/index.css  → Importações principais
```
